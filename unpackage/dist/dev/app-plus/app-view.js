...
var x=['./components/common/load-more.wxml','./components/index/index-list.wxml','./components/index/swiper-tab-head.wxml','./pages/index/index.wxml','./pages/mine/mine.wxml','./pages/news/news.wxml','./pages/paper/paper.wxml'];d_[x[0]]={}
...
var oJB=_oz(z,9,eFB,tEB,gg)
_(xIB,oJB)
var fKB=_n('view')
_rz(z,fKB,'class',10,eFB,tEB,gg)
_(xIB,fKB)
_(bGB,xIB)
return bGB
}
...
var z=gz$gwx_4()
var hMB=_n('view')
var oNB=_mz(z,'swiper-tab-head',['bind:__l',0,'bind:tabtap',1,'data-event-opts',1,'tabBars',2,'tabIndex',3,'vueId',4],[],e,s,gg)
_(hMB,oNB)
var cOB=_n('view')
_rz(z,cOB,'class',6,e,s,gg)
var oPB=_mz(z,'swiper',['bindchange',7,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var lQB=_v()
_(oPB,lQB)
var aRB=function(eTB,tSB,bUB,gg){
var xWB=_n('swiper-item')
var oXB=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',16,'class',1,'data-event-opts',2],[],eTB,tSB,gg)
var fYB=_v()
_(oXB,fYB)
var cZB=function(o2B,h1B,c3B,gg){
var l5B=_mz(z,'index-list',['bind:__l',23,'index',1,'item',2,'vueId',3],[],o2B,h1B,gg)
_(c3B,l5B)
return c3B
}
fYB.wxXCkey=4
_2z(z,21,cZB,eTB,tSB,gg,fYB,'item','index1','index1')
var a6B=_mz(z,'load-more',['bind:__l',27,'loadMore',1,'vueId',2],[],eTB,tSB,gg)
_(oXB,a6B)
_(xWB,oXB)
_(bUB,xWB)
return bUB
...
lQB.wxXCkey=4
_2z(z,14,aRB,e,s,gg,lQB,'items','index','index')
_(cOB,oPB)
_(hMB,cOB)
_(r,hMB)
return r
