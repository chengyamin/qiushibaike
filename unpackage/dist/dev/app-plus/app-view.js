...
var x=['./components/common/common-list.wxml','./components/common/load-more.wxml','./components/common/no-thing.wxml','./components/common/upload-images.wxml','./components/index/index-list.wxml','./components/index/swiper-tab-head.wxml','./components/news/news-nav-bar.wxml','./components/uni-icon/uni-icon.wxml','./components/uni-nav-bar/uni-nav-bar.wxml','./components/uni-popup/uni-popup.wxml','./components/uni-status-bar/uni-status-bar.wxml','./pages/add-input/add-input.wxml','./pages/index/index.wxml','./pages/mine/mine.wxml','./pages/news/news.wxml','./pages/paper/paper.wxml','./pages/search/search.wxml'];d_[x[0]]={}
...
var z=gz$gwx_8()
var xUD=_mz(z,'view',['bindtap',0,'class',1,'data-event-opts',1,'style',2],[],e,s,gg)
_(r,xUD)
return r
}
...
var c1D=_mz(z,'uni-status-bar',['bind:__l',4,'vueId',1],[],e,s,gg)
_(oZD,c1D)
}
...
var b7D=_mz(z,'uni-icon',['bind:__l',13,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(e6D,b7D)
_(a4D,e6D)
}
var t5D=_v()
...
var eJE=_mz(z,'uni-icon',['bind:__l',31,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(tIE,eJE)
_(lGE,tIE)
}
var aHE=_v()
...
var cPE=_mz(z,'uni-status-bar',['bind:__l',43,'vueId',1],[],e,s,gg)
_(fOE,cPE)
}
var hQE=_n('view')
...
var z=gz$gwx_10()
var cSE=_n('view')
var oTE=_mz(z,'view',['bindtap',0,'catchtouchmove',1,'class',1,'data-event-opts',2,'hidden',3,'style',4],[],e,s,gg)
_(cSE,oTE)
var lUE=_mz(z,'view',['class',6,'hidden',1],[],e,s,gg)
...
var bYE=_mz(z,'view',['bindtap',10,'class',1,'data-event-opts',2],[],e,s,gg)
_(aVE,bYE)
}
aVE.wxXCkey=1
_(cSE,lUE)
...
_(a0E,tAF)
_(c4E,a0E)
var eBF=_mz(z,'upload-images',['bind:__l',19,'bind:upload',1,'data-event-opts',2,'vueId',3],[],e,s,gg)
_(c4E,eBF)
var h5E=_v()
_(c4E,h5E)
...
var z=gz$gwx_13()
var xEF=_n('view')
var oFF=_mz(z,'swiper-tab-head',['bind:__l',0,'bind:tabtap',1,'data-event-opts',1,'tabBars',2,'tabIndex',3,'vueId',4],[],e,s,gg)
_(xEF,oFF)
var fGF=_n('view')
_rz(z,fGF,'class',6,e,s,gg)
var cHF=_mz(z,'swiper',['bindchange',7,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var hIF=_v()
_(cHF,hIF)
var oJF=function(oLF,cKF,lMF,gg){
var tOF=_n('swiper-item')
var ePF=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',16,'class',1,'data-event-opts',2],[],oLF,cKF,gg)
var bQF=_v()
_(ePF,bQF)
...
var oXF=_mz(z,'index-list',['bind:__l',24,'index',1,'item',2,'vueId',3],[],fUF,oTF,gg)
_(cVF,oXF)
return cVF
}
oRF.wxXCkey=4
_2z(z,22,xSF,oLF,cKF,gg,oRF,'item','index1','index1')
var cYF=_mz(z,'load-more',['bind:__l',28,'loadMore',1,'vueId',2],[],oLF,cKF,gg)
_(bQF,cYF)
}
else{bQF.wxVkey=2
var oZF=_mz(z,'no-thing',['bind:__l',31,'vueId',1],[],oLF,cKF,gg)
_(bQF,oZF)
}
bQF.wxXCkey=1
bQF.wxXCkey=3
...
hIF.wxXCkey=4
_2z(z,14,oJF,e,s,gg,hIF,'items','index','index')
_(fGF,cHF)
_(xEF,fGF)
_(r,xEF)
return r
...
var z=gz$gwx_15()
var e4F=_n('view')
var b5F=_mz(z,'news-nav-bar',['bind:__l',0,'bind:changeTab',1,'data-event-opts',1,'tabBars',2,'tabIndex',3,'vueId',4],[],e,s,gg)
_(e4F,b5F)
var o6F=_n('view')
_rz(z,o6F,'class',6,e,s,gg)
var x7F=_mz(z,'swiper',['bindchange',7,'class',1,'current',2,'data-event-opts',3,'style',4],[],e,s,gg)
var o8F=_n('swiper-item')
var f9F=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',12,'class',1,'data-event-opts',2],[],e,s,gg)
var c0F=_v()
_(f9F,c0F)
var hAG=function(cCG,oBG,oDG,gg){
var aFG=_mz(z,'common-list',['bind:__l',19,'index',1,'item',2,'vueId',3],[],cCG,oBG,gg)
_(oDG,aFG)
return oDG
}
c0F.wxXCkey=4
_2z(z,17,hAG,e,s,gg,c0F,'item','index','index')
var tGG=_mz(z,'load-more',['bind:__l',23,'loadtext',1,'vueId',2],[],e,s,gg)
_(f9F,tGG)
_(o8F,f9F)
_(x7F,o8F)
var eHG=_n('swiper-item')
var bIG=_mz(z,'scroll-view',['scrollY',-1,'class',26],[],e,s,gg)
var oJG=_n('view')
_rz(z,oJG,'class',27,e,s,gg)
var xKG=_mz(z,'input',['class',28,'placeholder',1,'placeholderClass',2],[],e,s,gg)
_(oJG,xKG)
_(bIG,oJG)
_(eHG,bIG)
_(x7F,eHG)
...
__wxAppCode__['pages/news/news.wxss']=setCssToHead([".",[1],"search-input{ border:1px solid; padding:",[0,20],"; }\n.",[1],"search-input\x3ewx-input{ border:1px solid; background: #F4F4F4; border-radius: ",[0,10],"; }\n",],undefined,{path:"./pages/news/news.wxss"});    
